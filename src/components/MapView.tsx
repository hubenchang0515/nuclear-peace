...
export default function MapView(props:MapProps) {
    ...
    useEffect(() => {
        ...
        const thermalRadiationCircle = new Circle(props.boom, 1000*thermalRadiation(props.tnt));
        ...
        const nuclearRadiationCircle = new Circle(props.boom, 1000*nuclearRadiation(props.tnt));
        ...
        const heavyBlastCircle = new Circle(props.boom, 1000*heavyBlast(props.tnt));
        ...
        const fireballCircle = new Circle(props.boom, 1000*fireball(props.tnt));
